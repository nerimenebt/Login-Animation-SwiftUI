...
struct ContentView: View {
    ...
    let gradient: LinearGradient = LinearGradient(gradient: Gradient(colors: [Color(red: 71/255, green: 198/255, blue: 255/255, opacity: 1.0), Color(red: 90/255, green: 131/255, blue: 255/255, opacity: 1.0)]), startPoint: .leading, endPoint: .trailing)
                ...
                VStack {
                    ...
                    ZStack {
                        RoundedRectangle(cornerRadius: 20, style: .circular)
                            .fill(Color(red: 71/255, green: 198/255, blue: 255/255, opacity: 1.0))
                        HStack {
                            Image("face")
    ...
    func getRandomPositions() -> [PlusPosition] {
        ...
        positions.append(PlusPosition(id: 2, color: Color(red: 90/255, green: 131/255, blue: 255/255, opacity: 1.0), offsetX: -42, offsetY: -50, delay: 0.225, scale: 0.5, opacity: 1, degree: Angle(degrees: -43)))
        positions.append(PlusPosition(id: 3, color: Color(red: 90/255, green: 131/255, blue: 255/255, opacity: 1.0), offsetX: 110, offsetY: -20, delay: 0.135, scale: 0.25, opacity: 0.95, degree: Angle(degrees: 43)))
        ...
        positions.append(PlusPosition(id: 6, color: Color(red: 90/255, green: 131/255, blue: 255/255, opacity: 1.0), offsetX: 120, offsetY: 102, delay: 0.2, scale: 0.65, opacity: 0.85, degree: Angle(degrees: 43)))
